  ...
  return (
    <aside className="w-[200px] hidden lg:flex sticky top-0 h-screen overflow-y-auto flex-col pt-8 pb-8">
      ...
      <div className="bg-white border border-stone-200 rounded-xl p-5 mb-6">
        <h3 className="font-lora text-[15px] font-semibold text-sage-800 mb-2">
          You&apos;re not alone
        </h3>
        <p className="text-[13px] text-stone-500 leading-relaxed">
          <strong className="text-stone-700"></strong> people shared a rant this
          week.
        </p>
      </div>
      ...
      <div>
        ...
        <div className="text-[13px] text-stone-500 leading-relaxed">
          SafeSpace uses temporary, anonymous aliases. Your real identity is
          forever hidden. No judgment, just a place to land.
        </div>
      </div>
    </aside>
  );
